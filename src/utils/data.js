export const SKILLS=[
    ...
    },
    {
        ...
        icon: "./images/prog.png",
        skills:[
              { skill: "Data Structure and Algorithm", percentage: "80%" }, 
              { skill: "Object Oriented Programming(OOPs)", percentage: "90%" },
        ],
    },
    {
        ...
        skills:[
              { skill: "Communication", percentage: "98%" }, 
              { skill: "Problem Solving", percentage: "85%" },
              { skill: "Teamwork and Collaboration", percentage: "90%" }, 
...
export const PROJECT=[
    ...
    
    {
        ...
        description:[
            ...
            "It features sleek animations for an engaging user experience"
